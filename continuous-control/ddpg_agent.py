...
WEIGHT_DECAY = 0  # L2 weight   ht decay


class Agent():
    """Interacts with and learns from the environment."""
    
    def __init__(self, state_size, action_size, num_agents, buffer_size, batch_size, gamma, tau, lr_actor, lr_critic, random_seed):
        ...
        #save_dot(self.actor_local,'actor.dot')
